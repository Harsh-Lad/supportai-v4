...
import {
  BarChart3, TrendingUp, MessageSquare, Bot, FileText,
  Ticket, Mail, Headphones, ArrowUp, ArrowDown
} from 'lucide-react'
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent>
            <div className="flex items-end gap-[2px] h-40">
              {conversationsTimeline.map((day, i) => (
                <div
                  key={day.date}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {[
              ...
              { label: 'Voice', value: channelBreakdown.voice, icon: Headphones, color: 'bg-purple-500' },
